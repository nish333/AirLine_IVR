 ...
 * Last generated by Orchestration Designer at: 2024-JUL-03  04:23:49 PM
 */
public class AgentTransfer extends com.avaya.sce.runtime.Form {
	...
	public void requestBegin(SCESession mySession)
	{
		...
		mySession.getVariableField(IProjectVariables.NODE,IProjectVariables.NODE_FIELD_EXITNODE).setValue("AgentTransfer");
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CallHistoryRecord");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		transfer = new com.avaya.sce.runtime.Transfer("AgentTransfer", "blindtransfer", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "prepareaai", com.avaya.sce.runtime.Transfer.VARIABLE, false, false);
		return transfer;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "AGENT TRANSFER NODE", ""));
		return(list);
	}
	/**
