 ...
 * Last generated by Orchestration Designer at: 2024-JUL-08  05:15:44 PM
 */
public class AgentTransfer2 extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2024-JUL-18  04:22:27 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ThanksPrompt");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("AGENT", ""));

		// create the transfer item
		transfer = new com.avaya.sce.runtime.Transfer("AgentTransfer2", "properties:transfervdn2", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "UCID456986 | EN", com.avaya.sce.runtime.Transfer.CONSTANT, false, false);
		return transfer;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "ENTER INTO AGENT TRANSFER TWO", ""));
		return(list);
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-JUL-18  04:22:27 PM
	 */
