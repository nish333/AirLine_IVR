 ...
 * Last generated by Orchestration Designer at: 2024-JUL-08  05:34:45 PM
 */
public class AgentTransfer3 extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("TransferAgent", ""));

		// create the transfer item
		transfer = new com.avaya.sce.runtime.Transfer("AgentTransfer3", "properties:transfervdn3", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "UCID3455 | EN", com.avaya.sce.runtime.Transfer.CONSTANT, false, false);
		return transfer;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "ENTER INTO AGENT TRANSFER THREE", ""));
		return(list);
	}
	/**
