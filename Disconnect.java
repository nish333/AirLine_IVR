 ...
 * Last generated by Orchestration Designer at: 2024-JUL-03  11:40:08 AM
 */
public class Disconnect extends com.avaya.sce.runtime.Disconnect {
	...
	{
		String disconnectreason = "Disconnect"; 
		mySession.getVariableField(IProjectVariables.NODE, IProjectVariables.NODE_FIELD_EXITNODE).getStringValue();
		mySession.getVariableField(IProjectVariables.NODE,IProjectVariables.NODE_FIELD_EXITNODE).setValue("Disconnect");
	 ...
	 * Last generated by Orchestration Designer at: 2024-JUL-22  05:19:51 PM
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "ENTER INTO DISCONNECT NODE", ""));
		return(list);
	}
	/**
