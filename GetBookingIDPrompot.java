...
import com.avaya.sce.runtimecommon.config.impl.UsersImpl;
 ...
 * Last generated by Orchestration Designer at: 2024-JUL-03  04:15:08 PM
 */
public class GetBookingIDPrompot extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2024-JUL-04  07:22:26 PM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("BookingIDPrompt", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("BookingID", "1.0", "english"));

		events = new java.util.ArrayList();
		properties = new java.util.ArrayList();

		nbest = 1;
		field = new com.avaya.sce.runtime.Field("GetBookingIDPrompot", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CheckBokingId");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "GETTING A BOOKING ID FROM THE USER", ""));
		return(list);
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-JUL-04  07:22:26 PM
	 */
	...
	public void requestBegin(SCESession mySession) {
		String UserInuput =null;
		mySession.getVariableField(IProjectVariables.USER_INPUT).setValue(UserInuput);
		mySession.getVariableField(IProjectVariables.USER_INPUT).getStringValue();
