 ...
 * Last generated by Orchestration Designer at: 2024-JUL-02  04:08:54 PM
 */
public class HangUp extends com.avaya.sce.runtime.Return {
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "CALL FLOW CLOULD BE ENDED", ""));
		return(list);
	}
}
