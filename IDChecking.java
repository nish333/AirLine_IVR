 ...
 * Last generated by Orchestration Designer at: 2024-JUL-16  04:00:04 PM
 */
public class IDChecking extends com.avaya.sce.runtime.Menu {
	...
	public void requestBegin(SCESession mySession)
	{
		...
		mySession.getVariableField(IProjectVariables.NODE,IProjectVariables.NODE_FIELD_EXITNODE).setValue("IDChecking");
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Yes", "1", true, "exact", "CheckBookID", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("untitled4", ""));
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "ENTER INTO BOOKING ID CHECKING", ""));
		return(list);
	}
}
