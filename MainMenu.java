 ...
 * Last generated by Orchestration Designer at: 2024-JUL-02  05:54:37 PM
 */
public class MainMenu extends com.avaya.sce.runtime.Menu {
	...
	public void requestBegin(SCESession mySession)
	{
		...
		mySession.getVariableField(IProjectVariables.NODE,IProjectVariables.NODE_FIELD_EXITNODE).setValue("MainMenu");
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("NnoInput", ""));
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("NnoMatch", ""));
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("NewBooking", "1", true, "exact", "TransferOperation", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("ExistingBooking", "2", true, "exact", "ExistingMainMenu", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Inquires", "3", true, "exact", "TransferOperation", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("MainMenuPrompt", ""));
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "ENTER INTO NEW USER MENU", ""));
		return(list);
	}
}
