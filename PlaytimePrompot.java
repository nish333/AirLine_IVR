 ...
 */
public class PlaytimePrompot extends com.avaya.sce.runtime.Form {
	...
	public void requestBegin(SCESession mySession)
	{
		...
		mySession.getVariableField(IProjectVariables.NODE,IProjectVariables.NODE_FIELD_EXITNODE).setValue("PlayTimePrompot");
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("DepartureTimePrompot", ""));
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "ENTER INTO PLAYING PROMPOT FOR DEPARTURE TIME", ""));
		return(list);
	}
	/**
